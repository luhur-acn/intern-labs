...
| [Capstone: IaC Mastery](capstones/capstone2/Project_Capstone_IaC.md) | Author Terraform modules from scratch, wire with Terragrunt, master state management | Advanced | Labs 8–13 |
| [Capstone: The Great Migration](capstones/capstone3/Project_Capstone_Import.md) | Discover legacy infrastructure via CLI/SDK and codify it into Terragrunt with `import` blocks | Advanced | Labs 1–13 |
